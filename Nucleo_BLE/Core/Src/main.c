...
// Private variables
static uint8_t rx_buf[20];  // Reception buffer
static uint8_t tx_buf[50];  // Transmission buffer
static char* tx_msg = "Hello from STM32";  // Message to send
volatile int ble_connected = 0;  // BLE connection status: 1 for connected, 0 for not connected

/* Private function prototypes */
void SystemClock_Config(void);
static void MX_GPIO_Init(void);
static void MX_DMA_Init(void);
static void MX_USART2_UART_Init(void);q
